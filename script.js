...
const easyQuestions = [
  ...
  { image: "images/q2.png", question: "問2.東場の場合、この手をあがったら点数は？", choices: ["役無し", "2000点", "3000点", "4800点"], correct: "3000点", explanation: "副底で20符で白が３枚（暗刻）あるので8符になり、ツモが2符なので合計で40符になる。\n門前自摸と白で2飜になって1000点オールで答えは3000点" },//ツモ白
  { image: "images/q3.png", question: "問3.東場の場合、この手をあがったら点数は？", choices: ["役無し", "16000点", "48000点", "96000点"], correct: "96000点", explanation: "国士無双13面待ちになるのでダブル役満です。" },//国士１３面
  { image: "images/q4.png", question: "問4.東場の場合、この手をあがったら点数は？\nなお、リーチしてから３巡目以降とする。", choices: ["役無し", "2000点", "3000点", "4800点"], correct: "2000点", explanation: "副底で20符で3萬が3枚（暗刻）あって単騎待ちで2符ロンなので合計で36符だけど繰り上がって40符になる。\nリーチしていてロンあがりの為、2飜になるので答えは2000点" },//リーチロン単騎
  { image: "images/q5.png", question: "問5.東場の場合、この手をあがったら点数は？", choices: ["48000点", "16000点", "32000点", "役無し"], correct: "48000点", explanation: "東と南と西と北のうち、3種類を3枚揃えるとできる小四喜という役満です。" },//小四喜
  { image: "images/q6.png", question: "問6.東場の場合、この手をあがったら点数は？\nなお、リーチしてから３巡目以降とする。", choices: ["4800点", "2000点", "3900点", "1000点"], correct: "3900点", explanation: "副底で20符で風牌の東が2枚（雀頭）あるので4符になって、西が3枚（暗刻）あるので8符で合計40符になる。\nリーチと門前自摸だけなので2飜になって1300点オールになるので答えは3900点" },//リーチツモ西
  { image: "images/q7.png", question: "問7.東場の場合、この手をあがったら点数は？", choices: ["1000点", "2000点", "2400点", "役無し"], correct: "役無し", explanation: "副底で20符で1筒が3枚（暗刻）あるので8符でペンチャン待ち（123の3や789の7など）なので2符、門前ロンで10符になり合計40符になる。\nこの問題はロンなので答えは役無し" },//役無し
  { image: "images/q8.png", question: "問8.東場の場合、この手をあがったら点数は？", choices: ["1000点", "2000点", "3900点", "役無し"], correct: "3900点", explanation: "副底で20符で単騎待ちで2符、東が3枚（暗刻）あるので8符の門前ロンで10符になるので合計40符になる。\nこのサイトは親固定なので自風場で1飜になり、東場で1飜となり合わせて2飜になるので答えは3900点" },//ダブ東ロン
  { image: "images/q9.png", question: "問9.東場の場合、この手をあがったら点数は？\nなお、リーチしてから３巡目以降とする。", choices: ["3000点", "3900点", "1000点", "2000点"], correct: "3900点", explanation: "副底で20符で1萬が３枚（暗刻）あるので8符になり、ペンチャン待ち（123の3や789の7など）なので2符に門前ロンが10符なので合符40符になる。\nリーチをしているので1飜あり、ドラ表示牌が2筒のため3筒がドラになるため1飜増えて合わせて2飜になるので答えは3900点" },//リーチドラ１ロン
  { image: "images/q10.png", question: "問10.東場の場合、この手をあがったら点数は？\nなお、リーチしてから３巡目以降とする。", choices: ["9600点", "7700点", "3900点", "5800点"], correct: "7700点", explanation: "副底で20符、単騎待ちで2符、ペンちゃん待ちなので2符に門前ロンなので10符がつき、合計で40符になります。\nこのサイトでは親固定なので、自風が東、場風も東（東場）ということで自風と場風が一致し、2翻分の役になります。そこにリーチをかけてアガったとすると、さらに1翻加わり、合計3翻になって答えは7700点" },//リーチドラ裏ロン
];
const mediumQuestions = [
  { image: "images/qm1.png", question: "問1.東場の場合、この手をあがったら 点数は？", choices: ["7700点", "4000点", "役無し", "3900点"], correct: "7700点", explanation: "副底で20符、2萬が暗刻で4符になり、門前ロンのため10符合計で36符だけど繰り上がって40符になる。\n萬子筒子索子にそれぞれ345があるので三色同順という役になり2飜、更に5の萬子が赤いので赤ドラになり1飜プラスされて3飜になるので答えは7700点" },//三色同順赤１ロン
  { image: "images/qm2.png", question: "問2.南場の場合、この手をあがったら 点数は？", choices: ["12000点", "20000点", "8000点", "16000点"], correct: "12000点", explanation: "副底で20符、東と南が暗刻な為8符8符の16符で自摸あがりなので2符合計で38符だけど繰り上がって40符になる。\nリーチ自摸で2飜、親なので自風の東で1飜貫貫場風の南で1飜で合計4飜となり答えが4000オールの12000点（満貫）となる" },//リー自摸東南
  { image: "images/q2.png", question: "この手をあがったら 点数は？", choices: ["7700点", "8000点", "12000点", "満貫"], correct: "満貫", explanation: "30符4翻は親のロンで満貫となります。" },
